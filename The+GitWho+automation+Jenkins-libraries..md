# The GitWho automation Jenkins-libraries.
...
> Do multiple checks and fixes against the git repository to assure the
...
BuildStatus could contain any text, But it's preferable to use Jenkins
